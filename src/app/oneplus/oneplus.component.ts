...
@Component({
  ...
  styleUrls: ['./oneplus.component.scss']
})
export class OneplusComponent {
  ...
  onePlus: Array<string> = ['OnePlus 10 3', 'OnePlus 9R', 'OnePlus 10 Pro', 'OnePlus 9 Pro']
  tweets: Array<Tweet> = []
  ...
  getAnalysis(onePlus: string){
    const params = new HttpParams().set('query', onePlus);
